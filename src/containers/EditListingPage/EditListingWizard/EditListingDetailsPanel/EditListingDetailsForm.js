            ...
            if (response.ok) {
              ...
              if (responseCode === 200) {
                formApi.batch(() => {
                  ...
                  formApi.change("pub_metines_pajamos", parseFloat(data?.body?.companyData?.data?.lastTurnover?.turnover));
                  ...
                  formApi.change("pub_pagrindinis_adresas", data?.body?.companyData?.data?.registrationAddress?.settlementName?.toString());
                });
              } else {
