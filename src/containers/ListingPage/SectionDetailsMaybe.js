    ...
    <section className={css.sectionDetails}>
      ...
      <ul className={css.details}>
        ...
        <li id="field_8" className={css.detailsRow} style={{ paddingBottom: "25px" }}>
          ...
          <span>
            {publicData.location.address
              ? publicData.location.address.split(',').slice(0, -1).join(', ')
              : ""}
          </span>
